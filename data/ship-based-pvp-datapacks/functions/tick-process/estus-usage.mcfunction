...
#なくなり次第CTを60固定にする(戦闘中のみ)
execute if score #Helper CombatMode matches 2.. as @a[scores={ship-num=1..5},nbt=!{Inventory:[{id:"minecraft:orange_dye",tag:{citTexture:Estus}}]}] at @s run scoreboard players set @s skill1-ct 60

#エスト瓶 ship-num:7～10向け
#即時回復Ⅳを発動
execute as @a[scores={ship-num=7..10,skill1-ct=0},predicate=ship-based-pvp-datapacks:estus-frask] at @s run effect give @s instant_health 1 3 true
#エスト回復エフェクト
execute as @a[scores={ship-num=7..10,skill1-ct=0},predicate=ship-based-pvp-datapacks:estus-frask] at @s run particle dust 0.953 0.596 0.000 1 ~ ~ ~ 0.5 0.5 0.5 1 20 normal @a
#エスト瓶を1個減らす
execute as @a[scores={ship-num=7..10,skill1-ct=0},predicate=ship-based-pvp-datapacks:estus-frask] at @s run clear @s orange_dye{citTexture:Estus} 1
#CTを20にする
execute as @a[scores={ship-num=7..10,skill1-ct=0},predicate=ship-based-pvp-datapacks:estus-frask] at @s run scoreboard players set @s skill1-ct 20
#なくなり次第CTを60固定にする
execute if score #Helper CombatMode matches 2.. as @a[scores={ship-num=7..10},nbt=!{Inventory:[{id:"minecraft:orange_dye",tag:{citTexture:Estus}}]}] at @s run scoreboard players set @s skill1-ct 60

#エスト瓶 ship-num:12～向け
#即時回復Ⅳを発動
execute as @a[scores={ship-num=12..,skill1-ct=0},predicate=ship-based-pvp-datapacks:estus-frask] at @s run effect give @s instant_health 1 3 true
#エスト回復エフェクト
execute as @a[scores={ship-num=12..,skill1-ct=0},predicate=ship-based-pvp-datapacks:estus-frask] at @s run particle dust 0.953 0.596 0.000 1 ~ ~ ~ 0.5 0.5 0.5 1 20 normal @a
#エスト瓶を1個減らす
execute as @a[scores={ship-num=12..,skill1-ct=0},predicate=ship-based-pvp-datapacks:estus-frask] at @s run clear @s orange_dye{citTexture:Estus} 1
#CTを20にする
...
#なくなり次第CTを60に固定する
execute if score #Helper CombatMode matches 2.. as @a[scores={ship-num=1..5},nbt=!{Inventory:[{id:"minecraft:light_blue_dye",tag:{citTexture:Estus}}]}] at @s run scoreboard players set @s skill2-ct 60
...
#なくなり次第CTを60に固定する
execute if score #Helper CombatMode matches 2.. as @a[scores={ship-num=6},nbt=!{Inventory:[{id:"minecraft:light_blue_dye",tag:{citTexture:Estus}}]}] at @s run scoreboard players set @s skill1-ct 60

#エストの灰瓶 ship-num:11向け(特殊)
#FPを240回復する。ただし、上限を突破する場合、それで統合する
execute as @a[scores={ship-num=11,skill1-ct=0},predicate=ship-based-pvp-datapacks:ashen-estus-frask] at @s run scoreboard players add @s FocusPoint 240
execute as @a[scores={ship-num=11,skill1-ct=0,FocusPoint=301..},predicate=ship-based-pvp-datapacks:ashen-estus-frask] at @s run scoreboard players set @s FocusPoint 300
#灰エスト回復エフェクト
execute as @a[scores={ship-num=11,skill1-ct=0},predicate=ship-based-pvp-datapacks:ashen-estus-frask] at @s run particle dust 0.698 0.796 0.894 1 ~ ~ ~ 0.5 0.5 0.5 1 20 normal @a
#エストの灰瓶を1個減らす
execute as @a[scores={ship-num=11,skill1-ct=0},predicate=ship-based-pvp-datapacks:ashen-estus-frask] at @s run clear @s light_blue_dye{citTexture:Estus} 1
#CTを40にする
execute as @a[scores={ship-num=11,skill1-ct=0},predicate=ship-based-pvp-datapacks:ashen-estus-frask] at @s run scoreboard players set @s skill1-ct 20
#なくなり次第CTを60に固定する
execute if score #Helper CombatMode matches 2.. as @a[scores={ship-num=11},nbt=!{Inventory:[{id:"minecraft:light_blue_dye",tag:{citTexture:Estus}}]}] at @s run scoreboard players set @s skill1-ct 60

#エストの灰瓶 ship-num:8～10向け
#FPを240回復する。ただし、上限を突破する場合、それで統合する
execute as @a[scores={ship-num=8..10,skill2-ct=0},predicate=ship-based-pvp-datapacks:ashen-estus-frask] at @s run scoreboard players add @s FocusPoint 240
...
execute as @a[scores={ship-num=9,skill2-ct=0,FocusPoint=251..},predicate=ship-based-pvp-datapacks:ashen-estus-frask] at @s run scoreboard players set @s FocusPoint 250
execute as @a[scores={ship-num=10,skill2-ct=0,FocusPoint=301..},predicate=ship-based-pvp-datapacks:ashen-estus-frask] at @s run scoreboard players set @s FocusPoint 300
#灰エスト回復エフェクト
execute as @a[scores={ship-num=8..10,skill2-ct=0},predicate=ship-based-pvp-datapacks:ashen-estus-frask] at @s run particle dust 0.698 0.796 0.894 1 ~ ~ ~ 0.5 0.5 0.5 1 20 normal @a
#エストの灰瓶を1個減らす
execute as @a[scores={ship-num=8..10,skill2-ct=0},predicate=ship-based-pvp-datapacks:ashen-estus-frask] at @s run clear @s light_blue_dye{citTexture:Estus} 1
#CTを30(魔法使い系20)にする
execute as @a[scores={ship-num=8..10,skill2-ct=0},predicate=ship-based-pvp-datapacks:ashen-estus-frask] at @s run scoreboard players set @s skill2-ct 30
#なくなり次第CTを60に固定する
execute if score #Helper CombatMode matches 2.. as @a[scores={ship-num=8..10},nbt=!{Inventory:[{id:"minecraft:light_blue_dye",tag:{citTexture:Estus}}]}] at @s run scoreboard players set @s skill2-ct 60

#エストの灰瓶 ship-num:12～向け
#FPを240回復する。ただし、上限を突破する場合、それで統合する
execute as @a[scores={ship-num=12..13,skill2-ct=0},predicate=ship-based-pvp-datapacks:ashen-estus-frask] at @s run scoreboard players add @s FocusPoint 240
execute as @a[scores={ship-num=16..,skill2-ct=0},predicate=ship-based-pvp-datapacks:ashen-estus-frask] at @s run scoreboard players add @s FocusPoint 240
...
#エストの灰瓶を1個減らす
execute as @a[scores={ship-num=12..,skill2-ct=0},predicate=ship-based-pvp-datapacks:ashen-estus-frask] at @s run clear @s light_blue_dye{citTexture:Estus} 1
#CTを30(魔法使い系20)にする
