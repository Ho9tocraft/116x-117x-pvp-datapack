...
execute if score #Helper CombatMode matches 2 as @a[scores={ship-num=16,health-spectate=59..}] at @s run effect give @s resistance 1 1 false
execute if score #Helper CombatMode matches 2 as @a[scores={ship-num=17,health-spectate=40..}] at @s run effect give @s resistance 1 1 false
