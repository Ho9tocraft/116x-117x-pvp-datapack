...
execute if score #Helper CombatMode matches 2 if score #Helper token-phase matches 0 if score #Helper token-sp-diamond matches ..29 run scoreboard players add #Helper token-sp-iron 1
...
execute if score #Helper CombatMode matches 2 if score #Helper token-phase matches 1 if score #Helper token-sp-diamond matches ..19 run scoreboard players add #Helper token-sp-iron 1
...
execute if score #Helper CombatMode matches 2 if score #Helper token-phase matches 2 if score #Helper token-sp-diamond matches ..15 run scoreboard players add #Helper token-sp-iron 1
...
execute if score #Helper CombatMode matches 2 if score #Helper token-phase matches 0 if score #Helper token-sp-diamond matches 30 run scoreboard players set #Helper token-sp-iron 0
...
execute if score #Helper CombatMode matches 2 if score #Helper token-phase matches 1 if score #Helper token-sp-diamond matches 20 run scoreboard players set #Helper token-sp-iron 0
...
execute if score #Helper CombatMode matches 2 if score #Helper token-phase matches 2 if score #Helper token-sp-diamond matches 16 run scoreboard players set #Helper token-sp-iron 0
