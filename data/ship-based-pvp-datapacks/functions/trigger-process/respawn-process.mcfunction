...
execute as @a[scores={ship-num=1..,killcount-Temp=1..,respawn-time=1..},gamemode=spectator] at @a[predicate=ship-based-pvp-datapacks:killstreaks,limit=1] run tp @s ^ ^1 ^-5
