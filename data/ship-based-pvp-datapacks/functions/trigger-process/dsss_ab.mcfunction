...
execute as @e[type=armor_stand,tag=dsss_aoe_red_C] at @s as @e[team=Blue,distance=..10,type=!#ship-based-pvp-datapacks:undead] at @s run effect give @s instant_damage 30 0 false
execute as @e[type=armor_stand,tag=dsss_aoe_red_C] at @s as @e[team=Blue,distance=..10,type=#ship-based-pvp-datapacks:undead] at @s run effect give @s instant_health 30 0 false
...
execute as @e[type=armor_stand,tag=dsss_aoe_blue_C] at @s as @e[team=Red,distance=..10,type=!#ship-based-pvp-datapacks:undead] at @s run effect give @s instant_damage 30 0 false
execute as @e[type=armor_stand,tag=dsss_aoe_blue_C] at @s as @e[team=Red,distance=..10,type=#ship-based-pvp-datapacks:undead] at @s run effect give @s instant_health 30 0 false
#6. armor_standを削除
