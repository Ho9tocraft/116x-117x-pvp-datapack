...
execute as @e[type=armor_stand,tag=dsss_aoe_red_C] at @s as @e[team=Blue,distance=..10] at @s run effect give @s instant_damage 60 2 false
...
execute as @e[type=armor_stand,tag=dsss_aoe_blue_C] at @s as @e[team=Red,distance=..10] at @s run effect give @s instant_damage 60 2 false
#6. armor_standを削除
