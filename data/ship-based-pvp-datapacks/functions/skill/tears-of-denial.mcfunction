#惜別の涙
execute as @a[scores={ship-num=4,skill3-ct=0,FocusPoint=100..},predicate=ship-based-pvp-datapacks:tears-of-denial,nbt=!{Inventory:[{id:"minecraft:totem_of_undying",Slot:-106b}]}] at @s run replaceitem entity @s weapon.offhand totem_of_undying 1
#FP消費: 100
