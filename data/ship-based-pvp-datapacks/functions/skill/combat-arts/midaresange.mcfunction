...
execute as @a[scores={ship-num=6,skill3-ct=0},predicate=ship-based-pvp-datapacks:divine-firelinkers-righthand-blade] at @s run scoreboard players set @s skill3-ct 35
