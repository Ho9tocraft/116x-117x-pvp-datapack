...
execute as @a[scores={ship-num=13,FocusPoint=20..,skill3-ct=0},predicate=ship-based-pvp-datapacks:luminosite-eternelle] at @s run scoreboard players set @s skill3-ct 240
#endregion
