...
#Consuming FP: 75
execute as @a[scores={ship-num=7,skill2-ct=0,FocusPoint=100..},predicate=ship-based-pvp-datapacks:old-hunters-bone] at @s run scoreboard players remove @s FocusPoint 75
#CT: 30 seconds
