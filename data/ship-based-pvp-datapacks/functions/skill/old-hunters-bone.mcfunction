#効果
execute as @a[scores={ship-num=7,skill2-ct=0,FocusPoint=90..},predicate=ship-based-pvp-datapacks:old-hunters-bone] at @s run effect give @s speed 20 3 false
execute as @a[scores={ship-num=7,skill2-ct=0,FocusPoint=90..},predicate=ship-based-pvp-datapacks:old-hunters-bone] at @s run effect give @s jump_boost 20 3 false
execute as @a[scores={ship-num=7,skill2-ct=0,FocusPoint=90..},predicate=ship-based-pvp-datapacks:old-hunters-bone] at @s run effect give @s regeneration 20 3 false
#Effects
