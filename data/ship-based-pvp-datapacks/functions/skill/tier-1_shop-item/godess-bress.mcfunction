...
execute as @a[predicate=ship-based-pvp-datapacks:tier-1_items/godess-bress,scores={skill1-ct=0,skill2-ct=0}] at @s run clear @s dragon_breath{citTexture:Elixer-1} 1
