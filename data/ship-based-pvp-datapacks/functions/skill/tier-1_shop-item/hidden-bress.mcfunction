...
execute as @a[predicate=ship-based-pvp-datapacks:tier-1_items/hidden-bress,scores={skill1-ct=0,skill2-ct=0,ship-num=11}] at @s run scoreboard players set @s FocusPoint 300
...
execute as @a[predicate=ship-based-pvp-datapacks:tier-1_items/hidden-bress,scores={skill1-ct=10,skill2-ct=10}] at @s run clear @s dragon_breath{citTexture:Elixer-2} 1
