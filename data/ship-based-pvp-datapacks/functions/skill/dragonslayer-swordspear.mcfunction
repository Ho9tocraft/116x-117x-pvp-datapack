...
execute as @a[scores={skill3-ct=0},predicate=ship-based-pvp-datapacks:dragonslayer-swordspear,team=Red] at @s as @e[tag=target_dsss_lightning_red] at @s run effect give @s instant_damage 60 2 false
...
execute as @a[scores={skill3-ct=0},predicate=ship-based-pvp-datapacks:dragonslayer-swordspear,team=Blue] at @s as @e[tag=target_dsss_lightning_blue] at @s run effect give @s instant_damage 60 2 false
...
#7. サウンドエフェクト
execute as @a[scores={skill3-ct=0},predicate=ship-based-pvp-datapacks:dragonslayer-swordspear] at @s run playsound block.end_gateway.spawn player @a[distance=..15]
#8. CTを設定
execute as @a[scores={skill3-ct=0},predicate=ship-based-pvp-datapacks:dragonslayer-swordspear] at @s run scoreboard players set @s skill3-ct 20
#EXTRA. 姫騎士以外の竜狩りの剣槍を削除
execute as @a[scores={skill3-ct=20},predicate=ship-based-pvp-datapacks:dragonslayer-swordspear] at @s unless score @s ship-num matches 11 run clear @s golden_sword{citTexture:NamelessKing} 1
