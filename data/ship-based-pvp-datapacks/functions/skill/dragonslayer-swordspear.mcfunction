...
#4.-6. 
execute as @a[scores={skill3-ct=0,FocusPoint=20..},predicate=ship-based-pvp-datapacks:dragonslayer-swordspear] at @s run schedule function ship-based-pvp-datapacks:trigger-process/dsss_ab 3s
#7. サウンドエフェクト
