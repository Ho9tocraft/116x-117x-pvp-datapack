...
execute as @a[scores={skill3-ct=0,FocusPoint=20..},predicate=ship-based-pvp-datapacks:dragonslayer-swordspear,team=Red] at @s as @e[tag=target_dsss_lightning_red,type=!#ship-based-pvp-datapacks:undead] at @s run effect give @s instant_damage 60 1 false
execute as @a[scores={skill3-ct=0,FocusPoint=20..},predicate=ship-based-pvp-datapacks:dragonslayer-swordspear,team=Red] at @s as @e[tag=target_dsss_lightning_red,type=#ship-based-pvp-datapacks:undead] at @s run effect give @s instant_health 60 1 false
...
execute as @a[scores={skill3-ct=0,FocusPoint=20..},predicate=ship-based-pvp-datapacks:dragonslayer-swordspear,team=Blue] at @s as @e[tag=target_dsss_lightning_blue,type=!#ship-based-pvp-datapacks:undead] at @s run effect give @s instant_damage 60 1 false
execute as @a[scores={skill3-ct=0,FocusPoint=20..},predicate=ship-based-pvp-datapacks:dragonslayer-swordspear,team=Blue] at @s as @e[tag=target_dsss_lightning_blue,type=#ship-based-pvp-datapacks:undead] at @s run effect give @s instant_health 60 1 false
