...
#1.5: 演出パーティクル
execute as @a[scores={ship-num=6,skill2-ct=0,FocusPoint=80..},predicate=ship-based-pvp-datapacks:soothing-sunlight] at @s run particle dust 0.953 0.596 0.000 1 ~ ~ ~ 8.0 0.2 8.0 1 400 normal @a
#2: 使用者は追加で回復（範囲はない）
...
#1: 抽出しつつ半径計算（distance=..8, teamも個別で見る）
execute as @a[scores={ship-num=11,skill2-ct=0,FocusPoint=64..},predicate=ship-based-pvp-datapacks:soothing-sunlight,team=Red] at @s as @e[team=Red,distance=..8,type=!#ship-based-pvp-datapacks:undead] at @s run effect give @s instant_health 1 5 false
execute as @a[scores={ship-num=11,skill2-ct=0,FocusPoint=64..},predicate=ship-based-pvp-datapacks:soothing-sunlight,team=Blue] at @s as @e[team=Blue,distance=..8,type=!#ship-based-pvp-datapacks:undead] at @s run effect give @s instant_health 1 5 false
execute as @a[scores={ship-num=11,skill2-ct=0,FocusPoint=64..},predicate=ship-based-pvp-datapacks:soothing-sunlight,team=Red] at @s as @e[team=Red,distance=..8,type=#ship-based-pvp-datapacks:undead] at @s run effect give @s instant_damage 1 5 false
execute as @a[scores={ship-num=11,skill2-ct=0,FocusPoint=64..},predicate=ship-based-pvp-datapacks:soothing-sunlight,team=Blue] at @s as @e[team=Blue,distance=..8,type=#ship-based-pvp-datapacks:undead] at @s run effect give @s instant_damage 1 5 false
#1.5: 演出パーティクル
execute as @a[scores={ship-num=11,skill2-ct=0,FocusPoint=64..},predicate=ship-based-pvp-datapacks:soothing-sunlight] at @s run particle dust 0.953 0.596 0.000 1 ~ ~ ~ 8.0 0.2 8.0 1 400 normal @a
#2: 使用者は追加で回復（範囲はない）
execute as @a[scores={ship-num=11,skill2-ct=0,FocusPoint=64..},predicate=ship-based-pvp-datapacks:soothing-sunlight] at @s run effect give @s instant_health 1 7 true
...
execute as @a[scores={ship-num=11,skill2-ct=0},predicate=ship-based-pvp-datapacks:soothing-sunlight] at @s run scoreboard players set @s skill2-ct 15
