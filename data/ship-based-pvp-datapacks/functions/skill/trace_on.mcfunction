...
#赤原猟犬: 
# 矢を軸とした半径15mの敵をターゲットし、追従する。スニークの必要はない。また、FPも消費しない。CTはないが、他スキルやアイテム使用などでスキル3のCTが0でない時、使用できない
execute as @a[scores={ship-num=12,TraceOn=0,skill3-ct=0},predicate=ship-based-pvp-datapacks:flundings] at @s as @e[type=arrow,distance=..1.1] at @s run tag @s add FLUNDINGS
execute as @a[scores={ship-num=12,TraceOn=0,skill3-ct=0},predicate=ship-based-pvp-datapacks:flundings,team=Red] at @s as @e[type=arrow,distance=..1.1] at @s run tag @s add FLUNDINGS_RED
execute as @a[scores={ship-num=12,TraceOn=0,skill3-ct=0},predicate=ship-based-pvp-datapacks:flundings,team=Blue] at @s as @e[type=arrow,distance=..1.1] at @s run tag @s add FLUNDINGS_BLU
execute as @e[type=arrow,tag=FLUNDINGS,tag=FLUNDINGS_RED] at @s facing entity @e[team=Blue,distance=..15,sort=nearest,limit=1] eyes run tp @s ^ ^ ^1.5
execute as @e[type=arrow,tag=FLUNDINGS,tag=FLUNDINGS_BLU] at @s facing entity @e[team=Red,distance=..15,sort=nearest,limit=1] eyes run tp @s ^ ^ ^1.5
...
execute as @a[scores={ship-num=12,TraceOn=2,skill3-ct=0},team=Red,predicate=ship-based-pvp-datapacks:excalibur-imagine] at @s positioned as @a[team=Blue,limit=1,sort=furthest,distance=..40] run particle dust 0.902 0.706 0.133 1 ~ ~ ~ 10 20 10 1 500 normal
#  青陣営
...
execute as @a[scores={ship-num=12,TraceOn=2,skill3-ct=0},team=Blue,predicate=ship-based-pvp-datapacks:excalibur-imagine] at @s positioned as @a[team=Blue,limit=1,sort=furthest,distance=..40] run particle dust 0.902 0.706 0.133 1 ~ ~ ~ 10 20 10 1 500 normal
