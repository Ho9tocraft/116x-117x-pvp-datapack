...
#抑止の守護者（攻撃力Ⅳ、耐性Ⅳ、移動速度Ⅳ）
execute as @a[scores={ship-num=12,awake_gauge=1..},tag=awake] at @s run effect give @s strength 4 3 false
execute as @a[scores={ship-num=12,awake_gauge=1..},tag=awake] at @s run effect give @s resistance 4 3 false
execute as @a[scores={ship-num=12,awake_gauge=1..},tag=awake] at @s run effect give @s speed 4 3 false
