...
execute as @e[type=skeleton,tag=awake,tag=Yuzuki_HandHeld,scores={awake_gauge=1..}] at @s as @e[team=Blue,distance=..5,type=!#ship-based-pvp-datapacks:undead] at @s run effect give @s instant_damage 10 0 false
execute as @e[type=skeleton,tag=awake,tag=Yuzuki_HandHeld,scores={awake_gauge=1..}] at @s as @e[team=Blue,distance=..5,type=#ship-based-pvp-datapacks:undead] at @s run effect give @s instant_health 10 0 false
