...
execute as @e[type=skeleton,tag=Yuzuki_HandHeld,tag=!Enrage_Ready] at @s if score @s health-enemy matches 1501..3500 run function ship-based-pvp-datapacks:enemy_data/skills/phase_2/awake
# Phase 3
...
execute as @e[type=skeleton,tag=Yuzuki_HandHeld,tag=!Enrage_Ready] at @s if score @s health-enemy matches 1..1500 run function ship-based-pvp-datapacks:enemy_data/skills/phase_3/awake
